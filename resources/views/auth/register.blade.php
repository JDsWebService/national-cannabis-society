                ...
                <div class="card-body">
                    ...
                    <form class="form-signin" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-label-group">
                            <input type="text" name="name" id="inputName" class="form-control @error('name') is-invalid @enderror" placeholder="Name" value="{{ old('name') }}" required autofocus>
                        ...
                        <a class="d-block text-center mt-2 small" href="{{ route('index') }}">Go Back</a>
                        <hr class="my-4">
...
@section('css')
    <style type="text/css">
        ...
        body {
          background: #007bff;
          background: linear-gradient(to right, #632c4f, #70bc41, #d6452f);
        }
        ...
        .card-signin .card-img-left {
          ...
          background: scroll center url('https://source.unsplash.com/oJJkFGn-AP4/414x512');
